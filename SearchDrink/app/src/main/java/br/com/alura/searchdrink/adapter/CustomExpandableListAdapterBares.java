...
public class CustomExpandableListAdapterBares extends BaseExpandableListAdapter {

    private Context context;
    private List<String> expandableListTitle;
    private HashMap<String, List<String>> expandableListDetail;

    public CustomExpandableListAdapterBares(Context context, List<String> expandableListTitle,
